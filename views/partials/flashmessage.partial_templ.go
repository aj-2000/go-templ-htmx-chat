	...
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if len(errMsgs) != 0 {
			...
			for _, msg := range errMsgs {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/partials/flashmessage.partial.templ`, Line: 18, Col: 16}
				}
		...
		if len(sucMsgs) != 0 {
			...
			for _, msg := range sucMsgs {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/partials/flashmessage.partial.templ`, Line: 39, Col: 16}
				}
